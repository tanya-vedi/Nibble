...
$y++;  }
 ?>
        <div class="w-col w-col-4">
          <a class="_4 blog-column w-inline-block" href="../portfolio/single-page-portfolio.html">
            <div class="date-line w-clearfix">
              <h6 class="date-blog"><?php echo $row['date'];  ?></h6>
            </div>
            <div class="div-text">
...
<!---  hardcoded text   -----
        <div class="w-col w-col-4">
          <a class="_2 _3 blog-column w-inline-block" href="../portfolio/single-page-portfolio.html">
            <div class="date-line w-clearfix">
...
-----   ends here --->
    ...
    <div class="containner-footer w-container"><img class="_2 logo-footer" src="../images/logo-pegasus2.svg" width="140">
      <p class="_2 lft">Copyright Themeple ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ© Pegasus&nbsp;- 2017&nbsp;</p>
